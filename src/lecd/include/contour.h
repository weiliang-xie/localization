...
struct ContourView
{
    ...
    // xwl 统计数据大小
    const int statistical_data_size_baseline = sizeof(cell_cnt_) + sizeof(pos_mean_) + sizeof(eig_vals_) + sizeof(eig_vecs_) + sizeof(vol3_mean_) + sizeof(com_) + sizeof(ecc_feat_) + sizeof(level_) + sizeof(poi_);
    const int statistical_data_size_test = sizeof(cell_cnt_) + sizeof(pos_mean_) + sizeof(eig_vals_) + sizeof(eig_vecs_) + sizeof(eccen_) + sizeof(ecc_feat_) + sizeof(vol3_mean_) + sizeof(level_) + sizeof(poi_);
